...
I focus on building practical, production-ready solutions and continuously improving my engineering skills through real-world development.
...
- Serverless backend development with Python and AWS  
- Designing scalable, cloud-based web applications  

## 📌 Featured Projects

### NBA Jersey E-Commerce
- Developed a full-stack e-commerce platform with authentication, cart, and order management
- Designed RESTful APIs and integrated MongoDB for dynamic product and order data
- Built responsive UI components using React for a seamless user experience

### The Pursuit of Reflection
- Built a Unity-based game focused on decision-making and reflective gameplay mechanics
- Implemented scene transitions, UI interactions, and player-driven outcomes
- Collaborated in a team environment using Git and agile task coordination

### BabyUniversity
- Developed a web application to manage educational content and user interaction
- Focused on frontend design and backend integration
- Ensured responsive UI and structured data handling

### IoTBAY
- Built a full-stack web application for IoT device management and tracking
- Implemented user authentication and database integration
- Designed system architecture for handling device-related data  

## 🌐 Connect with Me
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/kimlengthai/) 
[![Portfolio](https://img.shields.io/badge/Portfolio-17142b?style=for-the-badge&logo=vercel&logoColor=white)](https://kimleng-thai.netlify.app/)
